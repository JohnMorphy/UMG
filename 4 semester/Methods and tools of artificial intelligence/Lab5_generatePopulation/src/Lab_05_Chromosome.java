...
public abstract class Lab_05_Chromosome {
    ...
    public Lab_05_Chromosome() {
        this(-2.0, 2.0, 5, 19, 2);
    }

    public Lab_05_Chromosome(double lowerBound, double upperBound, int resolution, int size, int numOfGenomes) {
    ...
    private byte[][] generateChromosome() {
        ...
        for (int i = 0; i < numOfGenomes; i++) {
            while (true) {
                Lab_05_Chromosome.fillWithRandom(values[i]);
