...
namespace Zad_1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //przez referencje - wskaźniki, należałoby też odpowiednio pozmieniać na zmienne A B i C
            //Double A=0, B=0, C=0;
            //Odczyt(ref A, ref B, ref C);

            //kijowe to jest nie wiem jak z tego skorzystać, bo to nie wygląda dobrze
